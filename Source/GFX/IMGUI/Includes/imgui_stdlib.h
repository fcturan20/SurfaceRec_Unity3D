...
namespace ImGui
{
    ...
    IMGUI_API bool  InputTextWithHint(const char* label, const char* hint, string* str, ImGuiInputTextFlags flags = 0, ImGuiInputTextCallback callback = NULL, void* user_data = NULL);
}
